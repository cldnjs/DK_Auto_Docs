...
def load_column_data(sheet, col_num, start_num, end_num):
    """
    ...
    """
    column_data = []
    for row in range(start_num, end_num+1):
...
def load_row_data(sheet, row_num, start_num, end_num):
    """
    ...
    """
    row_data = []
    for col in range(start_num, end_num+1):
